...
namespace OpenQA.Selenium.Edge
{
    ...
    public sealed class EdgeDriverService : ChromiumDriverService
    {
        ...
        private EdgeDriverService(string executablePath, string executableFileName, int port, bool isLegacy, NetworkCredential user = null)
            : base(executablePath, executableFileName, port, MicrosoftWebDriverDownloadUrl, user)
        {
        ...
        public static EdgeDriverService CreateDefaultService(string driverPath, bool isLegacy = true, NetworkCredential user = null)
        {
            string serviceFileName = ChromiumDriverServiceFileName(MSEdgeDriverServiceFileName);
            if (isLegacy)
            {
            ...
            return CreateDefaultService(driverPath, serviceFileName, isLegacy, user);
        }
        ...
        /// <returns>A EdgeDriverService using a random port.</returns>
        public static EdgeDriverService CreateDefaultService(string driverPath, string driverExecutableFileName, bool isLegacy = true, NetworkCredential user = null)
        {
            return CreateDefaultService(driverPath, driverExecutableFileName, PortUtilities.FindFreePort(), isLegacy, user);
        }
        ...
        public static EdgeDriverService CreateDefaultService(string driverPath, string driverExecutableFileName, int port, bool isLegacy = true, NetworkCredential user = null)
        {
            return new EdgeDriverService(driverPath, driverExecutableFileName, port, isLegacy, user);
        }
    }
}
