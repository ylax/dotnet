...
namespace OpenQA.Selenium.Opera
{
    ...
    public sealed class OperaDriverService : DriverService
    {
        ...
        private OperaDriverService(string executablePath, string executableFileName, int port, NetworkCredential user = null)
            : base(executablePath, port, executableFileName, OperaDriverDownloadUrl, user)
        {
        }
        ...
        public static OperaDriverService CreateDefaultService(NetworkCredential user = null)
        {
        ...
        public static OperaDriverService CreateDefaultService(string driverPath, NetworkCredential user = null)
        {
            return CreateDefaultService(driverPath, OperaDriverServiceFileName, user);
        }
        ...
        /// <returns>A OperaDriverService using a random port.</returns>
        public static OperaDriverService CreateDefaultService(string driverPath, string driverExecutableFileName, NetworkCredential user = null)
        {
            return new OperaDriverService(driverPath, driverExecutableFileName, PortUtilities.FindFreePort(), user);
        }
    }
}
