...
namespace OpenQA.Selenium.Safari
{
    ...
    public sealed class SafariDriverService : DriverService
    {
        ...
        private SafariDriverService(string executablePath, string executableFileName, int port, NetworkCredential user = null)
            : base(executablePath, port, executableFileName, SafariDriverDownloadUrl, user)
        {
        }
        ...
        public static SafariDriverService CreateDefaultService(NetworkCredential user = null)
        {
            return CreateDefaultService(DefaultSafariDriverServiceExecutablePath, user);
        }
        ...
        public static SafariDriverService CreateDefaultService(string driverPath, NetworkCredential user = null)
        {
            return CreateDefaultService(driverPath, DefaultSafariDriverServiceExecutableName, user);
        }
        ...
        /// <returns>A ChromeDriverService using a random port.</returns>
        public static SafariDriverService CreateDefaultService(string driverPath, string driverExecutableFileName, NetworkCredential user = null)
        {
            return new SafariDriverService(driverPath, driverExecutableFileName, PortUtilities.FindFreePort(), user);
        }
    }
}
